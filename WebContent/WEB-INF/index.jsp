...
<body>
	...
	<c:if test="${utilisateur != null}">
		<div class="col-lg-6 col-sm-12">
				...
				<label for="buy">enchères ouvertes</label>
				<br>

				<input type="checkbox" id="buy" name="buy" value="current">
				<label for="buy">mes enchères en cours</label>
				<br>

				<input type="checkbox" id="buy" name="buy" value="win">
				<label for="buy">mes enchères remportées</label>
				<br>
				...
				<label for="sales">mes ventes en cours</label>
				<br>

				<input type="checkbox" id="sales" name="sales"
					value="upcommingsales">
				<label for="sales">ventes non débutées</label>
				<br>

				<input type="checkbox" id="sales" name="sales" value="closesales">
				<label for="sales">ventes terminées</label>
				<br>
		</div>
	</c:if>
